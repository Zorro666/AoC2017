...
namespace Day15
{
    class Program
    {
        static long aStart;
        static long bStart;
        static long aPrevious;
        static long bPrevious;
        ...
        static long GenerateA()
        {
            var aNew = aPrevious * 16807;
            aNew %= 2147483647;
            aPrevious = aNew;
            return aNew;
        }

        static long GenerateB()
        {
            var bNew = bPrevious * 48271;
            bNew %= 2147483647;
            bPrevious = bNew;
            return bNew;
        }
        ...
        public static long CountMatches2(long aStart, long bStart)
        {
            aPrevious = aStart;
            bPrevious = bStart;
